          ...
          <section class="relative py-20">
            ...
            <div class="container px-4 mx-auto">
              <div class="max-w-md mx-auto py-6 lg:py-12 px-4 lg:px-8 bg-white border rounded-xl text-center">
                ...
                {/* <h3 class="mb-2 text-3xl font-semibold font-heading">
                  Create new account
                </h3> */}
              ...
              />
                ...
                <span class="text-sm text-white">Signup with Google</span>
              </p>
              <p class="block  mb-6 text-sm font-semibold ">Or</p>{" "}
                  ...
                  <label class="inline-flex mb-10 text-left">
                    ...
                    <span class="-mt-1 inline-block text-sm text-gray-500">
                      ...
                      <a class="text-red-400 hover:underline" href="#Terms">
                        Terms, Data Policy
                      </a>{" "}
                      and{" "}
                      <a class="text-red-400 hover:underline" href="#Cookies">
                        Cookies Policy
                      </a>
                      .
                    </span>
