  ...
  return (
    <div>
      <section class="py-8 px-6">
        <div class="flex flex-wrap -mx-3 items-center">
          ...
          <div class="w-full lg:w-auto ml-auto px-3">
            <p
              class="inline-flex items-center py-2 px-3 mr-3 text-xs text-indigo-500 font-medium bg-white hover:bg-indigo-50 rounded"
              href="#"
            >
      ...
      <div className="container mx-auto grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 pt-6 gap-8">
                ...
                <div className="rounded border-gray-300  dark:border-gray-700 border-dashed border-2 h-72" />
                <div className="rounded border-gray-300  dark:border-gray-700 border-dashed border-2 h-72" />
                <div className="rounded border-gray-300  dark:border-gray-700 border-dashed border-2 h-72" />                <div className="rounded border-gray-300  dark:border-gray-700 border-dashed border-2 h-72" />
                <div className="rounded border-gray-300  dark:border-gray-700 border-dashed border-2 h-72" />
                <div className="rounded border-gray-300  dark:border-gray-700 border-dashed border-2 h-72" />
            </div>
    </div>
