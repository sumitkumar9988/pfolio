...
const AddProject = ({ history }) => {
  ...
  const onSave = (e) => {
    ...
    dispatch(addProject(data, history, "/home/project"));
  };
    ...
    <div>
      ...
      <div className=" mx-auto flex justify-center w-full h-full ">
        <div className="mt-8 w-full sm:w-8/12 m-4 md:w-3/6">
          <div class="w-full ">
            <h2 class="text-2xl font-bold text-center">Add Project</h2>
          </div>
          <div>
            <div class=" mt-4 mb-4 ">
              ...
              <div className="mx-auto grid sm:grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    class="py-4 pl-4  rounded text-sm focus:outline-none w-full  bg-gray-100 resize-none text-gray-800 flex-1"
                  />
                </div>
              </div>
            </div>
            <div class=" mt-4 mb-4 ">
              ...
              <textarea
                class="flex-1 py-4 pl-4  rounded text-sm focus:outline-none w-full  bg-gray-100 resize-none text-gray-800"
                id="description"
                name="description"
                value={description}
