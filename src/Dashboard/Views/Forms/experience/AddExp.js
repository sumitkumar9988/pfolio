...
const AddExperience = ({ history }) => {
  ...
  const onSave = (e) => {
    ...
    dispatch(addExperience(data, history, "/home/background", toast));
  };
    ...
    <div>
      ...
      <div className=" mx-auto flex justify-center w-full h-full ">
        <div className="mt-8 w-full sm:w-8/12 m-4 md:w-3/6">
          <div class="w-full ">
            <h2 class="text-2xl font-bold text-center">Add New Experience</h2>
          </div>
          <div>
            <div class=" mt-4 mb-4 ">
            ...
            <div className="flex items-center justify-center">
              <p
                onClick={onSave}
                class="inline-block cursor-pointer py-3 px-6 leading-none text-white bg-red-400 hover:bg-red-500 rounded shadow"
              >
                Save
              </p>
            </div>
