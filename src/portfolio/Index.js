              ...
              <section className="py-20">
                <div className="container px-4 mx-auto">
                  <div className="max-w-3xl pt-8 mx-auto text-center">
                    ...
                    <div className="mb-16">
                      <a
                        className={`inline-block w-full sm:w-auto px-6 py-2 text-sm text-white font-bold leading-loose bg-${data.mainTheme} hover:bg-${data.mainThemeDark} rounded transition duration-200`}
                        href="#project"
                      >
                        Know More
                      </a>
